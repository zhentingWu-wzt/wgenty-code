...
- [x] **Step 1: 确认 to_compact 无外部调用方(删除前最后核验)**
...
- [x] **Step 3: 删除 test_to_compact_returns_full_content**
...
- [x] **Step 4: 删除 test_offloaded_to_compact_returns_full_content**
...
- [x] **Step 8: cargo clippy --lib 确认无新警告**
...
- [x] **Step 1: 确认调用方 to_content() 签名未变,零改动**
...
- [x] **Step 2: 确认 compaction 未被本 change 改动**
...
- [x] **Step 5: cargo clippy --lib 无新警告**
...
- [x] **Step 7: 确认 git 工作区干净(所有改动已 commit)**
