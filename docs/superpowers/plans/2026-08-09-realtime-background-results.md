...
- [ ] **Step 1: Write the failing tool-layer test**
...
- [ ] **Step 3: Write the failing daemon retention/broadcast test**
...
- [ ] **Step 4: Run the daemon test to verify it fails**
...
- [ ] **Step 5: Implement the minimal propagation**
...
- [ ] **Step 7: Commit the bounded propagation change**
...
- [ ] **Step 3: Implement the event mapping and reader rename**
...
- [ ] **Step 5: Commit the TUI SSE consumption change**
...
- [ ] **Step 1: Write the failing recovery filter test**
...
- [ ] **Step 2: Run the focused recovery test to verify it fails**
...
- [ ] **Step 6: Commit recovery and test changes**
