...
- [ ] **Step 1: Write failing report validation, permissions, and lifecycle tests**
...
- [ ] **Step 2: Run the focused tests and observe the absent API**
...
- [ ] **Step 1: Write failing root-cause contract and dispatch tests**
...
- [ ] **Step 2: Run the focused tests and observe RootCause is absent**
...
- [ ] **Step 3: Implement the root-cause contract**
...
- [ ] **Step 2: Run the focused tests and observe the missing tool**
...
- [ ] **Step 3: Implement minimal authenticated persistence**
...
- [ ] **Step 1: Write the failing end-to-end contract assertion**
...
- [ ] **Step 2: Run it before implementation wiring is complete**
...
- [ ] **Step 3: Add documentation and test the real registry/tool boundary**
