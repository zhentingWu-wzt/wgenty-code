...
| codegraph_node p95 延迟 | 0.640 秒 | ≤ 基线 × 1.5 | rust-analyzer: ~10ms | bench-query.sh | #2 codegraph-query-and-explainability |
| 全量索引耗时 | 0.636 秒 | ≤ 基线 × 1.5 | sourcegraph: ~Xs | bench-perf.sh | #3 codegraph-multilang-and-deep-graph |
...
- 原始数据: /Users/wuzhenting/workspace/project/wgenty-code/scripts/codegraph-bench/results/20260620T164558Z/
